...
const TABS: {
...
}[] = [
    {
        ...
        cards: [
            {
                type: "Книга",
                title: "Методологические основы борьбы с коррупцией применительно к сфере противодействия отмыванию преступных доходов и финансированию терроризма",
            },
            {
                type: "Документ",
    ...
    },
    {
        ...
        cards: [
            {
                type: "Книга",
                title: "Современная система противодействия отмыванию преступных доходов и финансированию терроризма",
            },
            {
                type: "Статья",
                title: "Влияние нерегулируемого рынка криптовалют на экономическую безопасность Российской Федерации",
            },
        ],
    },
    {
        ...
        cards: [
            {
                type: "Документ",
                title: "Цифровая идентификация как инструмент противодействия отмыванию доходов и финансированию терроризма",
            },
            {
                type: "Книга",
                title: "Особенности национальных систем ПОД/ФТ государств Евразийского региона. Том 3. Республика Таджикистан",
            },
        ],
    },
];
