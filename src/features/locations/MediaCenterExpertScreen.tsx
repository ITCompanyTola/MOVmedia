...
import styles from "./MediaCenterExpertLocation.module.css";
...
export function MediaCenterExpertScreen({
    person,
    isCompleted,
    setReply,
    ...
    const [step, setStep] = useState<"intro" | "quiz">(
        isCompleted ? "quiz" : "intro",
    );
        ...
        return (
            <div className={styles.quiz}>
                <Card className={styles.quizCard}>
                    <Quiz
                        question={{
                            text: "Вам приходит сообщение от имени редакции: Срочно! Согласуйте публикацию и посмотрите макет статьи по ссылке. Ссылка ведёт на незнакомый сайт. Ваши действия в этой ситуации?",
                            icon: (
                                <svg
                                    width="44"
                                    height="44"
