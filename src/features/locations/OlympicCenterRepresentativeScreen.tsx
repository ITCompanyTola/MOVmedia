        ...
        <div className={styles.checkboxList}>
            {items.map((item) => {
                ...
                return (
                    <div
                        key={item.id}
                        className={`${styles.checkboxItem} ${isCorrect ? styles.selectItemCorrect : ""} ${isWrong ? styles.selectItemWrong : ""}`}
            ...
            <div className={styles.intro}>
                <div className={styles.introCards}>
                    ...
                    <Card className={styles.introCard}>
                        ...
                        <p className={styles.serviceDescription}>
                            Позволяет создавать и редактировать 9 типов тестовых
                            заданий и настраивать их по 7 параметрам
                        </p>
            ...
            <div className={styles.parameters}>
                <Card className={styles.parametersCard}>
                    <div className={styles.parametersInner}>
                        ...
                        <SelectList
                            type="checkbox"
                            items={PARAMETER_ITEMS.map((label) => ({
                                id: label,
                                label,
                            }))}
            ...
            <Card className={styles.quizCard}>
                ...
                <div className={styles.quizBody}>
                    ...
                    <SelectList
                        ...
                        selected={
                            new Set(selectedAnswerId ? [selectedAnswerId] : [])
                        }
                        answerState={answerState}
