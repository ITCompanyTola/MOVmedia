        ...
        return (
            <div className={styles.screen}>
                <div className={styles.screenImages}>
                    <img
                        src={podlozhka}
                        className={styles.screenPodlozhka}
                        alt=""
                    />
                    <img
                        src={profileImg}
                        className={styles.screenProfile}
                        alt=""
                    />
                </div>
                <Button
                        ...
                        <div className={styles.dropdownList}>
                            ...
                            <label>
                                <input
                                    ...
                                    onChange={(e) =>
                                        setIsCorrectChecked(e.target.checked)
                                    }
                                />
                                <span></span>
                                <Text variant="body-s">
                                    Международная Олимпиада (Китай)
                                </Text>
                            </label>
                            <label>
                                <input type="checkbox" disabled />
